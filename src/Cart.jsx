                        ...
                        <div key={item.id} className=' mb-5 md:flex md:gap-5 md:items-center border-b border-l p-2.5 md:p-5 '>
                            ...
                            <div className='md:w-fit flex gap-5 justify-between items-center '>
                                ...
                                <div className='w-24 flex items-center justify-between'>
                                    <button className="relative overflow-hidden rounded-md p-2  bg-blue-100 hover:bg-blue-600 hover:text-white  duration-300 [transition-timing-function:cubic-bezier(0.175,0.885,0.32,1.275)] active:translate-y-1 active:scale-x-110 active:scale-y-90" onClick={()=> onIncreaseQuantity(item)}>
                                    <FontAwesomeIcon icon={faPlus}/>
                                    </button>
                                        {item.quantity}
                                    <button className="relative overflow-hidden rounded-md p-2  bg-blue-100 hover:bg-blue-600 hover:text-white  duration-300 [transition-timing-function:cubic-bezier(0.175,0.885,0.32,1.275)] active:translate-y-1 active:scale-x-110 active:scale-y-90" onClick={()=> onDecreaseQuantity(item)}>
