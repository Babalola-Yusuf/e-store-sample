...
function Footer() {
    ...
    return (
        <div>
            <div className='pre-footer bg-blue-400 pt-5'>
                ...
                <div className=' bg-blue-500 flex items-center justify-between px-10 text-white'>
            ...
            <footer className="footer flex justify-between p-5 bg-blue-800 text-white">
